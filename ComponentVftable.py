...
type_defs = {
    ...
    "VEC_PENDINGPORTAL": "StdVecPendingPortal",
    "VECTOR_INT32": "StdVecInt32",
    "VEC_NPCPARTY": "StdVecNpcParty",
    "VECTOR_STRING": "StdVecString",
    "VEC_CUTTHROUGHWORLD": "StdVecCutThroughWorld",
    "grid::ICell": "Icell",
    ...
    "EntityID": "int",
    "types::aabb": "Aabb",
    "ENTITY_VEC": "StdVecEntityID",
    "TeleportComponentState::Enum": "TeleportComponentState",
    "VEC_OF_MATERIALS": "StdVecMaterialID",
    "VECTOR_FLOAT": "StdVecFloat",
    ...
    "std::vector<b2Body*>*": "StdVecPtrB2Body",
    ...
    "VECTOR_PATHNODE": "StdVecPathNode",
    ...
    "NINJA_ROPE_SEGMENT_VECTOR": "StdVecNinjaRopeSegment",
    "MOVETOSURFACE_TYPE::Enum": "MoveToSurfaceType",
    "types::iaabb": "Iaabb",
    "MATERIAL_VEC_DOUBLES": "StdVecDouble",
    ...
    "INVENTORYITEM_VECTOR": "StdVecInventoryItem",
    ...
    "VISITED_VEC": "StdVecVisited",
    "USTRING": "UString",
    "VECTOR_STR": "StdVecStr",
    "VECTOR_ENTITYID": "StdVecInt",
    ...
    "AIData": "AIData",
    "ceng::CArray2D<uint32>": "CArray2DUsize",
}
